    ...
    <div class="file">
      ...
      <div class="opinion">
        ...
        <el-form :inline="true" class="demo-form-inline">
          ...
          <el-form-item>
            <el-button type="info" id="opinion-btn">退回</el-button>
          </el-form-item>
        </el-form>
      </div>
...
export default {
  ...
  methods: {
    ...
    async downloadInvoice(time, id) {
      ...
      this.$axios({
        method: "post",
        url: "https://wemall.minephone.com/Invoice/api/public/index.php/api/admin/downloadInvoice",
        data: data,
      }).then((result) => {});
    },
  },
  ...
  async mounted() {
    ...
    await this.downloadInvoice(time, this.$route.query.id);
  },
};
</script>
  <style scoped>
